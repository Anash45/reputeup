let reviews = [
  {
    ...
    rating: 5,
    review:
      "Very easy to implement, adjust and deploy the widgets. The widgets looks great and the dashboard is super user friendly! I ran into a minor issue and the support team was very quick and released a new version with the fix within a day. Definitely would recommend to everyone!",
  },
  {
    name: "Rahul Mehta",
    designation: "UI Designer",
    rating: 5,
    review: "Nice team, great service! always on",
  },
  {
    name: "Anjali Verma",
  ...
  },
  {
    ...
    rating: 4,
    review:
      "Great company with sleek designs and amazing support. When contacted they reply quickly and helpfully, unlike many other companies out there. They are even receptive to feature requests and implement these quickly where appropriate. Awesome!",
  },
  {
    name: "Nisha Gupta",
